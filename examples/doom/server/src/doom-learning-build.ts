...
export async function readDoomLearningBuild(): Promise<DoomLearningBuild> {
  const result = await build({ entryPoints: ['examples/doom/server/src/session.ts', 'examples/doom/server/src/doom-learning-models.ts',
    'examples/doom/server/src/doom-vm-evaluations.ts', 'examples/doom/server/src/doom-evaluation-vm-provider.ts',
