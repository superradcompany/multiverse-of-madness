...
export function localGameSessions(location: string): GameSessionLink[] {
  ...
  return [
    { id: 'doom-main', game: 'doom', gameLabel: 'Doom', title: 'Doom demo', description: 'Explore futures and follow the selected route.', url: url(4317) },
    { id: 'chess-main', game: 'chess', gameLabel: 'Chess', title: 'Chess demo', description: 'Compare moves and replay the selected game.', url: url(4321) },
  ];
}
