...
import { learningProposalKinds, type LearningProposalKind } from '../../../packages/contracts/src/learning.ts';
import { activeSkills } from '../../../packages/contracts/src/skills.ts';
...
export function doomSupervisorEvidence(saved: SessionCheckpoint, compact = false) {
  ...
  return JSON.parse(JSON.stringify({
    main: { id: world.view.id, learning: world.view.learning, state: decisionState(world.view.state, saved.view.objective, world.history, [], timing.actionTicks),
      stats: decisionStatistics(world.view.state, world.stats), plan: world.view.plan },
    timing,
